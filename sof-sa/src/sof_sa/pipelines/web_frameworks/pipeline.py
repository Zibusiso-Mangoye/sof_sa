...
from ..nodes import count_unique_items_in_column, rename_values_in_col_on_index, add_missing_values_in_index, merge_dfs_on_index

def create_pipeline(**kwargs) -> Pipeline:
    column = 'params:web_frameworks'
    ...
    return pipeline([
        ...
        node(
            name= 'add_items_in_2018_dataset',
            func= add_missing_values_in_index,
            inputs=['2018_processed_renaming', column],
            outputs='2018_processed_adding'
        ),
        node(
        ...
        node(
            ...
            inputs=['2018_processed_adding', '2019_processed', '2020_processed', '2021_processed', 'params:years'],
            outputs='web_frameworks'
        )
    ])
