...
def main() -> None:
    ...
    db.load_data_into_db("raw_stackoverflow2018", staging_credentials, filepath="data\survey_results_public_2018.csv")
    db.load_data_into_db("raw_stackoverflow2019", staging_credentials, filepath="data\survey_results_public_2019.csv")
    db.load_data_into_db("raw_stackoverflow2020", staging_credentials, filepath="data\survey_results_public_2020.csv")
    db.load_data_into_db("raw_stackoverflow2021", staging_credentials, filepath="data\survey_results_public_2021.csv")
    ...
    db.load_data_into_db("languages", production_credentials, df=languages)
    db.load_data_into_db("future_languages", production_credentials, df=future_languages)
    db.load_data_into_db("databases", production_credentials, df=databases)
    db.load_data_into_db("future_databases", production_credentials, df=future_databases)
    db.load_data_into_db("platforms", production_credentials, df=platforms)
    db.load_data_into_db("future_platforms", production_credentials, df=future_platforms)
    db.load_data_into_db("web_frameworks", production_credentials, df=web_frameworks)
    db.load_data_into_db("future_web_frameworks", production_credentials, df=future_web_frameworks)
    db.load_data_into_db("age", production_credentials, df=age)
    db.load_data_into_db("gender", production_credentials, df=gender)
